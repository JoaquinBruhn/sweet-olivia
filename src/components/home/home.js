          ...
          <Col className="logosSVG">
            <span>
              <svg width="40" height="40" viewBox="0 0 42 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M39.6875 0.1875H2.3125C1.51738 0.1875 0.875 0.829883 0.875 1.625V30.375C0.875 31.1701 1.51738 31.8125 2.3125 31.8125H39.6875C40.4826 31.8125 41.125 31.1701 41.125 30.375V1.625C41.125 0.829883 40.4826 0.1875 39.6875 0.1875ZM4.10938 3.42188H37.8906V8.8125H4.10938V3.42188ZM37.8906 28.5781H4.10938V12.7656H37.8906V28.5781ZM27.2441 25.7031H34.6562C34.8539 25.7031 35.0156 25.5414 35.0156 25.3438V22.1094C35.0156 21.9117 34.8539 21.75 34.6562 21.75H27.2441C27.0465 21.75 26.8848 21.9117 26.8848 22.1094V25.3438C26.8848 25.5414 27.0465 25.7031 27.2441 25.7031Z" fill="black"/>
                </svg>
                </span>
                <div className="svgText">
